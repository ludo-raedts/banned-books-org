...
- **`Langyang.`** (id=5274, slug=`langyang`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
- **`Ou`** (id=5275, slug=`ou`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
- **`Meibao.`** (id=5276, slug=`meibao`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
- **`Shiyun`** (id=5278, slug=`shiyun`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Zhu`** (id=5408, slug=`zhu`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
- **`Yaoming.`** (id=5409, slug=`yaoming`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
...
- **`Fuzeng.`** (id=5471, slug=`fuzeng`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
- **`Bingxiang.`** (id=5473, slug=`bingxiang`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
- **`Zhenyu`** (id=5475, slug=`zhenyu`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Higgins`** (id=4773, slug=`higgins`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
- **`Andrew.`** (id=4774, slug=`andrew`, 2 book(s)) — SHARED → unlink from this book [trailing-period: bug victim] — bio: null
- **`Cottrell`** (id=4775, slug=`cottrell`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Ho`** (id=4978, slug=`ho`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Yen-bo.`** (id=4846, slug=`yen-bo`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
...
- **`Jiazhen.`** (id=4960, slug=`jiazhen`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
- **`Wen`** (id=4962, slug=`wen`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Cheng`** (id=5105, slug=`cheng`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
- **`Xiaonong`** (id=5106, slug=`xiaonong`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Dai`** (id=5171, slug=`dai`, 2 book(s)) — SHARED → unlink from this book — bio: null
- **`Yaoting.`** (id=5172, slug=`yaoting`, 2 book(s)) — SHARED → unlink from this book [trailing-period: bug victim] — bio: null
- **`Tan`** (id=5173, slug=`tan`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
- **`Huiyun`** (id=5174, slug=`huiyun`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Yuyi`** (id=5200, slug=`yuyi`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Zhiming.`** (id=5286, slug=`zhiming`, 2 book(s)) — SHARED → unlink from this book [trailing-period: bug victim] — bio: null
- **`Zhengheng`** (id=5288, slug=`zhengheng`, 2 book(s)) — SHARED → unlink from this book — bio: null
...
- **`Hua.`** (id=5292, slug=`hua`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
- **`Juming`** (id=5294, slug=`juming`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Lai`** (id=5366, slug=`lai`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
- **`Qizhi`** (id=5367, slug=`qizhi`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Shaohua`** (id=4935, slug=`shaohua`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Lixiong`** (id=5236, slug=`lixiong`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
- **`Karl.`** (id=5242, slug=`karl`, 1 book(s)) — EXCLUSIVE → safe to rename [trailing-period: bug victim] — bio: null
...
- **`Costa`** (id=17353, slug=`costa`, 1 book(s)) — EXCLUSIVE → safe to rename — bio: null
...
365 distinct author rows.

- `Anonymous` (id=33, slug=`anonymous`, 1611 book(s))
- `Voltaire` (id=67, slug=`voltaire`, 7 book(s))
- `Aristophanes` (id=150, slug=`aristophanes`, 2 book(s))
- `Sapphire` (id=233, slug=`sapphire`, 1 book(s))
- `Unknown` (id=421, slug=`unknown-author`, 1 book(s))
- `Montesquieu` (id=478, slug=`montesquieu`, 3 book(s))
- `Hergé` (id=578, slug=`herge`, 2 book(s))
- `Stendhal` (id=592, slug=`stendhal`, 1 book(s))
- `Ovid` (id=607, slug=`ovid`, 2 book(s))
- `Benyamin` (id=626, slug=`benyamin`, 1 book(s))
- `Amir` (id=792, slug=`amir`, 1 book(s))
- `DK` (id=1267, slug=`dk`, 6 book(s))
- `Ameriie` (id=1381, slug=`ameriie`, 1 book(s))
- `Chii` (id=2120, slug=`chii`, 1 book(s))
- `Medina` (id=2134, slug=`medina`, 1 book(s))
- `Chugong` (id=2220, slug=`chugong`, 1 book(s))
- `Aliki` (id=2534, slug=`aliki`, 2 book(s))
- `Parramon` (id=2611, slug=`parramon`, 1 book(s))
- `Nanashi` (id=2772, slug=`nanashi`, 4 book(s))
- `O'Keeffe` (id=2786, slug=`okeeffe`, 1 book(s))
- `Dobbs` (id=3066, slug=`dobbs`, 2 book(s))
- `Eunnie` (id=3585, slug=`eunnie`, 1 book(s))
- `Nasdijj` (id=3603, slug=`nasdijj`, 1 book(s))
- `Nicke` (id=3720, slug=`nicke`, 1 book(s))
- `M` (id=3753, slug=`m`, 1 book(s))
- `Ayuko` (id=4084, slug=`ayuko`, 1 book(s))
- `Compiled` (id=4329, slug=`compiled`, 1 book(s))
- `Afaq` (id=4374, slug=`afaq`, 1 book(s))
- `Unknown` (id=4391, slug=`unknown`, 3 book(s))
- `Desert` (id=4405, slug=`desert`, 1 book(s))
- `Avi` (id=4487, slug=`avi`, 2 book(s))
- `Iona` (id=4495, slug=`iona`, 1 book(s))
- `Madonna` (id=4519, slug=`madonna`, 3 book(s))
- `Walter` (id=4579, slug=`walter`, 3 book(s))
- `Han` (id=4605, slug=`han`, 6 book(s))
- `Li` (id=4607, slug=`li`, 5 book(s))
- `Lee` (id=4646, slug=`lee`, 1 book(s))
- `d'Alembert` (id=4666, slug=`dalembert`, 1 book(s))
- `He` (id=4682, slug=`he`, 2 book(s))
- `Carroll` (id=4686, slug=`carroll`, 1 book(s))
- `Lam` (id=4744, slug=`lam`, 1 book(s))
- `Kollár` (id=4747, slug=`kollar`, 1 book(s))
- `Bacon` (id=4789, slug=`bacon`, 1 book(s))
- `Saich` (id=4796, slug=`saich`, 1 book(s))
- `Eriugena` (id=4823, slug=`eriugena`, 1 book(s))
- `Simone` (id=4854, slug=`simone`, 1 book(s))
- `Maimonides` (id=4865, slug=`maimonides`, 1 book(s))
- `Cheek` (id=4875, slug=`cheek`, 1 book(s))
- `Zunzi` (id=4882, slug=`zunzi`, 14 book(s))
- `Cai` (id=4901, slug=`cai`, 4 book(s))
- `Kusike` (id=4919, slug=`kusike`, 1 book(s))
- `Huang` (id=4945, slug=`huang`, 3 book(s))
- `Chen` (id=4976, slug=`chen`, 7 book(s))
- `Spence` (id=5024, slug=`spence`, 2 book(s))
- `Sanxiaderen` (id=5039, slug=`sanxiaderen`, 1 book(s))
- `Liangzhen` (id=5051, slug=`liangzhen`, 1 book(s))
- `Boyang` (id=5075, slug=`boyang`, 1 book(s))
- `Deng` (id=5086, slug=`deng`, 2 book(s))
- `Tianba` (id=5088, slug=`tianba`, 1 book(s))
- `Heiyannan` (id=5132, slug=`heiyannan`, 1 book(s))
- `vawongsir` (id=5147, slug=`vawongsir`, 1 book(s))
- `Jianwu` (id=5157, slug=`jianwu`, 2 book(s))
- `Qidengsheng` (id=5201, slug=`qidengsheng`, 1 book(s))
- `Wuwen` (id=5202, slug=`wuwen`, 1 book(s))
- `Weise` (id=5203, slug=`weise`, 3 book(s))
- `Guo` (id=5247, slug=`guo`, 1 book(s))
- `Jingfuzi` (id=5249, slug=`jingfuzi`, 1 book(s))
- `Liushoushizi` (id=5281, slug=`liushoushizi`, 1 book(s))
- `Westad` (id=5342, slug=`westad`, 1 book(s))
- `Hiroaki.` (id=5362, slug=`hiroaki`, 1 book(s)) **[trailing period — bug victim]**
- `Weibieren` (id=5380, slug=`weibieren`, 1 book(s))
- `Goodstadt` (id=5385, slug=`goodstadt`, 2 book(s))
- `Yao` (id=5485, slug=`yao`, 1 book(s))
- `Eberhard` (id=5553, slug=`eberhard`, 4 book(s))
- `Samois` (id=5594, slug=`samois`, 1 book(s))
- `Ishikei` (id=5615, slug=`ishikei`, 1 book(s))
- `Tarazoo` (id=5708, slug=`tarazoo`, 1 book(s))
- `Carlos` (id=5840, slug=`carlos`, 1 book(s))
- `Asphyxia` (id=6153, slug=`asphyxia`, 1 book(s))
- `Weegee` (id=6476, slug=`weegee`, 1 book(s))
- `Aeschylus` (id=6499, slug=`aeschylus`, 1 book(s))
- `Kalidasa` (id=6709, slug=`kalidasa`, 1 book(s))
- `One` (id=7151, slug=`one`, 1 book(s))
- `Konstanchinoff` (id=7251, slug=`konstanchinoff`, 1 book(s))
- `Gubachen` (id=7273, slug=`gubachen`, 1 book(s))
- `Sikolov` (id=7287, slug=`sikolov`, 1 book(s))
- `Medviejiev` (id=7292, slug=`medviejiev`, 1 book(s))
- `Simonev` (id=7295, slug=`simonev`, 1 book(s))
- `Sarkey` (id=7308, slug=`sarkey`, 1 book(s))
- `Colielik` (id=7328, slug=`colielik`, 1 book(s))
- `Shehedrin` (id=7330, slug=`shehedrin`, 1 book(s))
- `Kursminsky` (id=7333, slug=`kursminsky`, 1 book(s))
- `Constantine` (id=7380, slug=`constantine`, 1 book(s))
- `Ostrovski` (id=7394, slug=`ostrovski`, 1 book(s))
- `Pe-I` (id=7400, slug=`pe-i`, 1 book(s))
- `Yin-I` (id=7403, slug=`yin-i`, 3 book(s))
- `Lieboyakoff` (id=7405, slug=`lieboyakoff`, 1 book(s))
- `Gorki` (id=7430, slug=`gorki`, 1 book(s))
- `Manieff` (id=7440, slug=`manieff`, 1 book(s))
- `Gorky` (id=7480, slug=`gorky`, 1 book(s))
- `Landi` (id=7506, slug=`landi`, 1 book(s))
- `Zahari` (id=7519, slug=`zahari`, 1 book(s))
- `Ehrenberg` (id=7521, slug=`ehrenberg`, 1 book(s))
- `Stalin` (id=7529, slug=`stalin`, 10 book(s))
- `Lafulinief` (id=7545, slug=`lafulinief`, 1 book(s))
- `Koncharov` (id=7556, slug=`koncharov`, 1 book(s))
- `Karpinsky` (id=7563, slug=`karpinsky`, 1 book(s))
- `Kalnin` (id=7564, slug=`kalnin`, 1 book(s))
- `Kina` (id=7570, slug=`kina`, 1 book(s))
- `Kaganovich` (id=7575, slug=`kaganovich`, 1 book(s))
- `Kosygin` (id=7588, slug=`kosygin`, 1 book(s))
- `Leonchiev` (id=7597, slug=`leonchiev`, 1 book(s))
- `Caruso` (id=7603, slug=`caruso`, 1 book(s))
- `Pravada` (id=7620, slug=`pravada`, 1 book(s))
- `Kielmiker` (id=7628, slug=`kielmiker`, 1 book(s))
- `Adreyev` (id=7639, slug=`adreyev`, 1 book(s))
- `Annie` (id=7641, slug=`annie`, 1 book(s))
- `Magini` (id=7647, slug=`magini`, 1 book(s))
- `Rosenthal` (id=7657, slug=`rosenthal`, 1 book(s))
- `Lida` (id=7671, slug=`lida`, 1 book(s))
- `Karpovski` (id=7683, slug=`karpovski`, 1 book(s))
- `William` (id=7765, slug=`william`, 1 book(s))
- `Juwita` (id=7842, slug=`juwita`, 1 book(s))
- `Penajaya` (id=7844, slug=`penajaya`, 1 book(s))
- `Mahani` (id=7852, slug=`mahani`, 1 book(s))
- `MS` (id=7859, slug=`ms`, 1 book(s))
- `Mastris` (id=7862, slug=`mastris`, 2 book(s))
- `Azam` (id=7901, slug=`azam`, 1 book(s))
- `Shirifah` (id=7902, slug=`shirifah`, 1 book(s))
- `Rokiah` (id=7903, slug=`rokiah`, 1 book(s))
- `Hashim` (id=7907, slug=`hashim`, 1 book(s))
- `Hanafi` (id=7925, slug=`hanafi`, 1 book(s))
- `Sam` (id=7926, slug=`sam`, 2 book(s))
- `Manmathan` (id=7940, slug=`manmathan`, 1 book(s))
- `Yati` (id=7941, slug=`yati`, 1 book(s))
- `Swary` (id=7943, slug=`swary`, 1 book(s))
- `Lely` (id=7944, slug=`lely`, 1 book(s))
- `Rajawali` (id=7947, slug=`rajawali`, 1 book(s))
- `Puspita` (id=7950, slug=`puspita`, 1 book(s))
- `Rezman` (id=7970, slug=`rezman`, 1 book(s))
- `Lisha` (id=7972, slug=`lisha`, 1 book(s))
- `Mr.` (id=7982, slug=`mr`, 1 book(s)) **[trailing period — bug victim]**
- `Larry` (id=7992, slug=`larry`, 1 book(s))
- `Hasanaha` (id=7996, slug=`hasanaha`, 1 book(s))
- `Ermas` (id=8037, slug=`ermas`, 1 book(s))
- `Magnus` (id=8088, slug=`magnus`, 1 book(s))
- `ClementEgerton` (id=8123, slug=`clementegerton`, 1 book(s))
- `Maswan` (id=8148, slug=`maswan`, 1 book(s))
- `Amiyati` (id=8155, slug=`amiyati`, 1 book(s))
- `Savatage` (id=8170, slug=`savatage`, 1 book(s))
- `Testament` (id=8171, slug=`testament`, 1 book(s))
- `Amiyamia` (id=8178, slug=`amiyamia`, 1 book(s))
- `Senno-Knife` (id=8216, slug=`senno-knife`, 1 book(s))
- `Kowariyo` (id=8279, slug=`kowariyo`, 1 book(s))
- `Zaery` (id=8355, slug=`zaery`, 1 book(s))
- `Priya` (id=8363, slug=`priya`, 2 book(s))
- `Mathan` (id=8364, slug=`mathan`, 1 book(s))
- `Sangkaracharier` (id=8374, slug=`sangkaracharier`, 1 book(s))
- `Sudarmaji` (id=8447, slug=`penterjemah-sudarmaji-s-pd-gruphermes-mlg`, 1 book(s))
- `Casandra` (id=8541, slug=`casandra`, 1 book(s))
- `Tamilvanan` (id=8545, slug=`tamilvanan`, 3 book(s))
- `Ujin` (id=8546, slug=`ujin`, 1 book(s))
- `Zunar` (id=8547, slug=`zunar`, 2 book(s))
- `Yudi` (id=8595, slug=`yudi`, 1 book(s))
- `Armansyah` (id=8611, slug=`armansyah`, 1 book(s))
- `Manya` (id=8656, slug=`manya`, 1 book(s))
- `Al-Asyqar` (id=8678, slug=`al-asyqar`, 1 book(s))
- `Pkm` (id=8705, slug=`pkm`, 1 book(s))
- `Bellesa` (id=8727, slug=`bellesa`, 1 book(s))
- `Nssignature` (id=8731, slug=`nssignature`, 1 book(s))
- `Album` (id=8790, slug=`album`, 1 book(s))
- `Zaiko` (id=8798, slug=`zaiko`, 1 book(s))
- `Kohske` (id=8827, slug=`kohske`, 1 book(s))
- `Ciotka` (id=8968, slug=`ciotka`, 1 book(s))
- `Lofu` (id=8984, slug=`lofu`, 1 book(s))
- `Anónimo` (id=9077, slug=`anonimo`, 2 book(s))
- `Arnóldov` (id=9084, slug=`arnoldov`, 1 book(s))
- `Artesano` (id=9087, slug=`artesano`, 1 book(s))
- `Barsa` (id=9107, slug=`barsa`, 2 book(s))
- `Bruckner` (id=9152, slug=`bruckner`, 1 book(s))
- `Probrazhensli` (id=9154, slug=`probrazhensli`, 1 book(s))
- `Copi` (id=9199, slug=`copi`, 1 book(s))
- `Erasmo` (id=9251, slug=`erasmo`, 1 book(s))
- `Eudeba` (id=9254, slug=`eudeba`, 2 book(s))
- `Meyerhold` (id=9387, slug=`meyerhold`, 1 book(s))
- `Procopio-Boselli` (id=9468, slug=`procopio-boselli`, 1 book(s))
- `Reiser` (id=9474, slug=`reiser`, 1 book(s))
- `Salvat` (id=9501, slug=`salvat`, 1 book(s))
- `Varios` (id=9570, slug=`varios`, 2 book(s))
- `Omarsaid` (id=9665, slug=`omarsaid`, 1 book(s))
- `Andraud` (id=9702, slug=`andraud`, 1 book(s))
- `Apfel` (id=9709, slug=`apfel`, 1 book(s))
- `Argueyrolles` (id=9714, slug=`argueyrolles`, 1 book(s))
- `Aron` (id=9716, slug=`aron`, 1 book(s))
- `Barbusse` (id=9727, slug=`barbusse`, 1 book(s))
- `Baruch` (id=9742, slug=`baruch`, 2 book(s))
- `Basseches` (id=9744, slug=`basseches`, 1 book(s))
- `Baudrillart` (id=9746, slug=`baudrillart`, 1 book(s))
- `Beuve-Méry` (id=9790, slug=`beuve-mery`, 1 book(s))
- `Bils` (id=9794, slug=`bils`, 1 book(s))
- `Binet-Valmer` (id=9795, slug=`binet-valmer`, 1 book(s))
- `Buk` (id=9852, slug=`buk`, 1 book(s))
- `Campagnolo` (id=9854, slug=`campagnolo`, 1 book(s))
- `Charles-Jose` (id=9875, slug=`charles-jose`, 1 book(s))
- `Chatelion` (id=9878, slug=`chatelion`, 1 book(s))
- `Chesterton` (id=9882, slug=`chesterton`, 1 book(s))
- `Coram` (id=9896, slug=`coram`, 1 book(s))
- `Delabache` (id=9926, slug=`delabache`, 2 book(s))
- `Delavignette` (id=9928, slug=`delavignette`, 1 book(s))
- `Domela` (id=9946, slug=`domela`, 1 book(s))
- `Donnadieu` (id=9952, slug=`donnadieu`, 1 book(s))
- `Duberge` (id=9961, slug=`duberge`, 1 book(s))
- `Dzelepy` (id=9975, slug=`dzelepy`, 2 book(s))
- `Eden` (id=9980, slug=`eden`, 1 book(s))
- `Ercoli` (id=9995, slug=`ercoli`, 4 book(s))
- `Erzberger` (id=9997, slug=`erzberger`, 1 book(s))
- `Fischer` (id=10011, slug=`fischer`, 1 book(s))
- `Fournier` (id=10022, slug=`fournier`, 1 book(s))
- `Francia` (id=10027, slug=`francia`, 1 book(s))
- `Garretto` (id=10050, slug=`garretto`, 1 book(s))
- `Gauthier-Lathuille` (id=10054, slug=`gauthier-lathuille`, 1 book(s))
- `Gillet` (id=10063, slug=`gillet`, 1 book(s))
- `Gros` (id=10075, slug=`gros`, 1 book(s))
- `Grzesinski` (id=10077, slug=`grzesinski`, 1 book(s))
- `Hansi` (id=10094, slug=`hansi`, 1 book(s))
- `Hurbert-Jacques` (id=10133, slug=`hurbert-jacques`, 1 book(s))
- `Ignatieff` (id=10135, slug=`ignatieff`, 1 book(s))
- `Ignotissimus` (id=10136, slug=`ignotissimus`, 1 book(s))
- `Israël` (id=10143, slug=`israel`, 1 book(s))
- `Jolidon` (id=10156, slug=`jolidon`, 1 book(s))
- `Kadmi-Cohen` (id=10161, slug=`kadmi-cohen`, 1 book(s))
- `Kaplan` (id=10163, slug=`kaplan`, 1 book(s))
- `Kaus` (id=10165, slug=`kaus`, 2 book(s))
- `Kœstler` (id=10182, slug=`koestler`, 1 book(s))
- `Kracauer` (id=10186, slug=`kracauer`, 1 book(s))
- `Kerakowski` (id=10187, slug=`kerakowski`, 1 book(s))
- `Kriwitsky` (id=10189, slug=`kriwitsky`, 1 book(s))
- `Ladoux` (id=10194, slug=`ladoux`, 4 book(s))
- `Lapaquellerie` (id=10209, slug=`lapaquellerie`, 1 book(s))
- `Laurent` (id=10221, slug=`laurent`, 1 book(s))
- `Leblanc` (id=10226, slug=`leblanc`, 1 book(s))
- `Lemoine` (id=10237, slug=`lemoine`, 1 book(s))
- `Lénine` (id=10239, slug=`lenine`, 15 book(s))
- `Lewandowski` (id=10245, slug=`lewandowski`, 1 book(s))
- `Magali` (id=10273, slug=`magali`, 1 book(s))
- `Maimonide` (id=10276, slug=`maimonide`, 1 book(s))
- `Mandel` (id=10280, slug=`mandel`, 1 book(s))
- `Maurer` (id=10298, slug=`maurer`, 1 book(s))
- `Montfort` (id=10319, slug=`montfort`, 1 book(s))
- `Moussat` (id=10328, slug=`moussat`, 1 book(s))
- `Muhlstein` (id=10330, slug=`muhlstein`, 1 book(s))
- `Noury` (id=10351, slug=`noury`, 1 book(s))
- `Oudard` (id=10356, slug=`oudard`, 1 book(s))
- `Pernot` (id=10362, slug=`pernot`, 4 book(s))
- `Pierredon` (id=10372, slug=`pierredon`, 1 book(s))
- `Pierre-Jean` (id=10374, slug=`pierre-jean`, 1 book(s))
- `Redier` (id=10400, slug=`redier`, 1 book(s))
- `Regamey` (id=10403, slug=`regamey`, 2 book(s))
- `Rivaud` (id=10419, slug=`rivaud`, 1 book(s))
- `Rousseau` (id=10448, slug=`rousseau`, 2 book(s))
- `Saint-Cere` (id=10463, slug=`saint-cere`, 1 book(s))
- `Salomon-Kcœchlin` (id=10471, slug=`salomon-kcoechlin`, 1 book(s))
- `Salvemini` (id=10473, slug=`salvemini`, 1 book(s))
- `Sarolea` (id=10476, slug=`sarolea`, 1 book(s))
- `Scheidemann` (id=10483, slug=`scheidemann`, 1 book(s))
- `Schuschnigg` (id=10487, slug=`schuschnigg`, 1 book(s))
- `Schwarzbuch` (id=10488, slug=`schwarzbuch`, 1 book(s))
- `Schwarz-Rotbuch` (id=10489, slug=`schwarz-rotbuch`, 1 book(s))
- `Seidewitz` (id=10491, slug=`seidewitz`, 1 book(s))
- `Sem` (id=10492, slug=`sem`, 1 book(s))
- `Seton-Watson` (id=10498, slug=`seton-watson`, 1 book(s))
- `Sforza` (id=10499, slug=`sforza`, 5 book(s))
- `Sonolet` (id=10513, slug=`sonolet`, 1 book(s))
- `Stekel` (id=10523, slug=`stekel`, 3 book(s))
- `Tabouis` (id=10536, slug=`tabouis`, 1 book(s))
- `Thuliez` (id=10547, slug=`thuliez`, 1 book(s))
- `Toutey` (id=10549, slug=`toutey`, 1 book(s))
- `Trintzius` (id=10554, slug=`trintzius`, 1 book(s))
- `Trotsky` (id=10555, slug=`trotsky`, 1 book(s))
- `Untel` (id=10561, slug=`untel`, 1 book(s))
- `Vermeil` (id=10583, slug=`vermeil`, 1 book(s))
- `Verne` (id=10585, slug=`verne`, 1 book(s))
- `Violan` (id=10589, slug=`violan`, 1 book(s))
- `Viot` (id=10590, slug=`viot`, 1 book(s))
- `Voigt` (id=10591, slug=`voigt`, 1 book(s))
- `Xxx` (id=10607, slug=`xxx`, 2 book(s))
- `Yvon` (id=10610, slug=`yvon`, 2 book(s))
- `Zeryns` (id=10614, slug=`zeryns`, 1 book(s))
- `Zwingelstein` (id=10618, slug=`zwingelstein`, 1 book(s))
- `Molière` (id=11722, slug=`moliere`, 1 book(s))
- `Apuleius` (id=11763, slug=`apuleius`, 1 book(s))
- `Bandi` (id=11808, slug=`bandi`, 2 book(s))
- `Darmawan` (id=11813, slug=`darmawan`, 1 book(s))
- `UNESCO` (id=11855, slug=`unesco`, 1 book(s))
- `Vatsyayana` (id=11898, slug=`vatsyayana`, 2 book(s))
- `Mazhar-ul-Haq` (id=12037, slug=`mazhar-ul-haq`, 1 book(s))
- `Sophocles` (id=12193, slug=`sophocles`, 1 book(s))
- `Plato` (id=12194, slug=`plato`, 1 book(s))
- `al-Jabiri` (id=12281, slug=`al-jabiri`, 1 book(s))
- `Mu'mir` (id=12282, slug=`mumir`, 1 book(s))
- `al-Mandakar` (id=12283, slug=`al-mandakar`, 1 book(s))
- `Mahura` (id=12292, slug=`mahura`, 2 book(s))
- `пер` (id=12349, slug=`per`, 1 book(s))
- `Ратибор` (id=12408, slug=`ratibor`, 1 book(s))
- `QuinRose` (id=12465, slug=`quinrose`, 1 book(s))
- `Homer` (id=12467, slug=`homer`, 1 book(s))
- `Atinuke` (id=12553, slug=`atinuke`, 1 book(s))
- `Saburouta` (id=12560, slug=`saburouta`, 2 book(s))
- `Kaito` (id=12876, slug=`kaito`, 7 book(s))
- `CoreKnowledge` (id=12891, slug=`coreknowledge`, 1 book(s))
- `MariNaomi` (id=12965, slug=`marinaomi`, 1 book(s))
- `Yin` (id=13213, slug=`yin`, 1 book(s))
- `Wahrmund` (id=13221, slug=`wahrmund`, 1 book(s))
- `Benjamin` (id=13244, slug=`benjamin`, 1 book(s))
- `Oistros` (id=13312, slug=`oistros`, 1 book(s))
- `Beresowski` (id=13325, slug=`beresowski`, 1 book(s))
- `Vigilant` (id=13441, slug=`vigilant`, 2 book(s))
- `Ackermann` (id=13533, slug=`ackermann`, 1 book(s))
- `Siegfried` (id=13604, slug=`siegfried`, 2 book(s))
- `El-Correi` (id=13613, slug=`el-correi`, 1 book(s))
- `Konstanz` (id=13678, slug=`konstanz`, 1 book(s))
- `Asiaticus` (id=13788, slug=`asiaticus`, 1 book(s))
- `Miles` (id=13813, slug=`miles`, 1 book(s))
- `Veriphantor` (id=14022, slug=`veriphantor`, 3 book(s))
- `Hartung` (id=14104, slug=`hartung`, 1 book(s))
- `Glaukos` (id=14120, slug=`glaukos`, 1 book(s))
- `Sawaty` (id=14176, slug=`sawaty`, 1 book(s))
- `Prag` (id=14182, slug=`prag`, 1 book(s))
- `Deuter` (id=14255, slug=`deuter`, 1 book(s))
- `Hossdorf` (id=14387, slug=`hossdorf`, 1 book(s))
- `Ernste` (id=14463, slug=`ernste`, 2 book(s))
- `Kondor` (id=14682, slug=`kondor`, 1 book(s))
- `Titayna` (id=14768, slug=`titayna`, 2 book(s))
- `Konradin` (id=14780, slug=`konradin`, 1 book(s))
- `Cochem` (id=14963, slug=`cochem`, 1 book(s))
- `Veridicus` (id=15125, slug=`veridicus`, 1 book(s))
- `Harys` (id=15225, slug=`harys`, 1 book(s))
- `Anti-Nautikus` (id=15257, slug=`anti-nautikus`, 1 book(s))
- `Wellinghusen` (id=15270, slug=`wellinghusen`, 1 book(s))
- `Wermuth-Stieber` (id=15460, slug=`wermuth-stieber`, 1 book(s))
- `Germanicus` (id=15552, slug=`germanicus`, 1 book(s))
- `Frateco` (id=15603, slug=`frateco`, 1 book(s))
- `Ali-Czeh` (id=15732, slug=`ali-czeh`, 1 book(s))
- `Emko` (id=15748, slug=`emko`, 1 book(s))
- `Deng-Bao-Sjang` (id=15831, slug=`deng-bao-sjang`, 1 book(s))
- `Salvadri` (id=16055, slug=`salvadri`, 1 book(s))
- `Harzheim` (id=16060, slug=`harzheim`, 1 book(s))
- `Frantz` (id=16199, slug=`frantz`, 1 book(s))
- `Losa` (id=16248, slug=`losa`, 1 book(s))
- `Sorin` (id=16355, slug=`sorin`, 1 book(s))
- `Bosch-Fidus` (id=16357, slug=`bosch-fidus`, 1 book(s))
- `Eccardus` (id=16564, slug=`eccardus`, 1 book(s))
- `Rossen` (id=16718, slug=`rossen`, 1 book(s))
- `Pitigrilli` (id=16817, slug=`pitigrilli`, 7 book(s))
- `Horta` (id=16854, slug=`horta`, 2 book(s))
- `Colette` (id=16888, slug=`colette`, 1 book(s))
- `Outros` (id=16966, slug=`outros`, 1 book(s))
- `Stuka` (id=17016, slug=`stuka`, 1 book(s))
- `Bruhl` (id=17196, slug=`bruhl`, 1 book(s))
- `Dostoievsky` (id=17224, slug=`dostoievsky`, 1 book(s))
- `Ho-Chi-Minh` (id=17247, slug=`ho-chi-minh`, 1 book(s))
- `Sokovieds` (id=17263, slug=`sokovieds`, 1 book(s))
- `Proudhon` (id=17462, slug=`proudhon`, 1 book(s))
- `Ionesco` (id=17586, slug=`ionesco`, 1 book(s))
- `Vercors` (id=17677, slug=`vercors`, 1 book(s))
