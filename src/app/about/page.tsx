        ...
        <SectionShell tone="white" eyebrow="Personal">
          <div className="max-w-3xl mx-auto">
            ...
            <article className="prose prose-gray prose-a:text-oxblood prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900">
              ...
              <p>
                In 2019 I visited the Bebelplatz Memorial in Berlin. It&apos;s a small underground room visible through a glass plate in the square — rows of empty white bookshelves, marking the spot where, on 10 May 1933, students of the Nazi German Student Union burned around 20,000 books they had branded &ldquo;un-German.&rdquo; Inscribed on a bronze plaque nearby is a line from Heinrich Heine: <em>&ldquo;Where they burn books, they will in the end also burn people.&rdquo;</em>{' '}Heine wrote it in 1820, in a play about the Spanish Inquisition&apos;s burning of the Quran. More than a century before the Nazis proved him right.
              </p>
              <p>
