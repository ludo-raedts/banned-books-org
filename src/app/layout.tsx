  ...
  return (
    ...
    >
      <head>
        ...
        {/* Mastodon profile verification (rel="me" backlink). */}
        <link rel="me" href="https://mastodon.social/@bannedbooks" />
      </head>
          ...
          <div className="max-w-5xl mx-auto px-4 py-8 text-xs text-gray-500">
            <nav aria-label="Footer" className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-6">
              ...
              <div>
                ...
                <ul className="space-y-1.5">
                  ...
                  <li><Link href="/get-banned-books" className="hover:text-gray-800 transition-colors">Get banned books</Link></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-1.5">
                  ...
                  <li><Link href="/organizations" className="hover:text-gray-800 transition-colors">Organisations to support</Link></li>
            ...
            <div className="mt-8 pt-4 border-t border-gray-100 flex items-center justify-between gap-4 text-gray-400">
              ...
              <div className="flex items-center gap-4 shrink-0">
                ...
                <a
                  href="https://mastodon.social/@bannedbooks"
                  target="_blank"
                  rel="me noopener noreferrer"
                  aria-label="Banned Books on Mastodon"
                  className="hover:text-gray-700 transition-colors"
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" aria-hidden="true">
                    <path d="M23.27 5.31c-.36-2.66-2.69-4.76-5.45-5.16C17.36.08 15.59 0 12 0h-.03C8.39 0 7.61.08 7.15.15 4.46.54 2.01 2.43 1.42 5.12.83 7.81.77 10.79.88 13.51c.16 3.91.19 4.4.92 6.6.92 2.79 3.91 4.6 6.96 4.6 2.83 0 4.95-1.41 4.95-1.41l-.1-2.27s-2.7.85-5.73.75c-3-.1-3.16-1.83-3.34-2.84a8.55 8.55 0 0 1-.08-.38c2.69.66 4.99.49 5.65.41 3.74-.45 7-2.76 7.41-4.87.65-3.33.6-8.13.6-8.13l-.25-.66zm-3.95 9.46h-2.45V8.81c0-1.27-.53-1.91-1.6-1.91-1.18 0-1.77.76-1.77 2.27v3.29h-2.44V9.17c0-1.51-.59-2.27-1.77-2.27-1.07 0-1.6.64-1.6 1.91v5.96H5.24V8.62c0-1.27.32-2.28.97-3.02.67-.74 1.55-1.12 2.64-1.12 1.27 0 2.23.49 2.86 1.46l.61 1.02.61-1.02c.63-.97 1.59-1.46 2.86-1.46 1.09 0 1.97.38 2.64 1.12.65.74.97 1.75.97 3.02v6.15z" />
                  </svg>
                </a>
                <a
                  href="/feed.xml"
