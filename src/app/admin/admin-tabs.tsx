...
export default function AdminTabs() {
  ...
  return (
    <nav
      className="flex gap-0.5 sm:gap-1 border-b border-gray-200 dark:border-gray-800 -mt-2 mb-6 overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
