...
const YELLOW = 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300'
...
export const STATUS_BADGE_CLASS: Record<QueueStatus, string> = {
  ...
  deferred:       'bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-300',
}
