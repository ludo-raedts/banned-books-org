  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-16 flex flex-col gap-8">
      ...
      <div className="bg-brand-light border-l-4 border-brand pl-6 pr-4 py-6 rounded-r-xl">
        <p className="text-xs font-medium uppercase tracking-widest text-brand/70 mb-3">Order confirmed</p>
      ...
      {downloadHref ? (
        <section className="rounded-2xl border border-gray-200 bg-gray-50 p-6 sm:p-8 flex flex-col gap-4 items-start">
        ...
        <section className="rounded-2xl border border-amber-200 bg-amber-50 p-6 sm:p-8 flex flex-col gap-3">
          ...
          <form>
            <button
              type="submit"
              className="text-sm font-medium underline text-amber-900 hover:no-underline"
            >
              Refresh
            </button>
          </form>
      ...
      <section className="text-sm text-gray-700 leading-relaxed flex flex-col gap-4">
        {email ? (
          <p>
        ...
        <p>
          ...
          <Link href="/about#get-in-touch" className="underline hover:text-gray-900">
            contact form
          </Link>{' '}
