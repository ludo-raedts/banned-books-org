...
In 2019 I visited the Bebelplatz Memorial in Berlin. It's a small underground room visible through a glass plate in the square — rows of empty white bookshelves, marking the spot where, on 10 May 1933, students of the Nazi German Student Union burned around 20,000 books they had branded "un-German." Inscribed on a bronze plaque nearby is a line from Heinrich Heine: *"Where they burn books, they will in the end also burn people."* Heine wrote it in 1820, in a play about the Spanish Inquisition's burning of the Quran. More than a century before the Nazis proved him right.
