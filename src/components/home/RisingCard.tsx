...
export default function RisingCard({ book }: { book: RisingBook }) {
  ...
  return (
    <Link
      ...
      className="hover-lift-card group flex gap-3 bg-white dark:bg-gray-900 border border-neutral-200 dark:border-gray-700 rounded-sm p-3 h-full"
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-1 text-[10px] uppercase tracking-wider text-neutral-600 dark:text-gray-400">
          This week
        </div>
        <h3 className="book-title mt-1 font-serif text-sm font-semibold leading-snug text-gray-900 dark:text-gray-50 line-clamp-2">
          {book.title}
        </h3>
        {book.author && (
